...
{
	// This function is used to set the port number
	// used for USB/IP connections. It takes a string argument,
	// which it tries to parse as a decimal integer (base 10).
	// If it is successful, it sets the global
	// variable usbip_port to this number.
...
// pack and unpack numerical values for network
